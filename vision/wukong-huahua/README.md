...
Wukong-Huahua is a diffusion-based model that perfomrs text-to-image task, which was developed by the *Huawei Noah's Ark Lab* in cooperation with the *Distributed & Parallel Software Lab* and *Ascend Product Develop Unit*. It is trained on [Wukong dataset](https://wukong-dataset.github.io/wukong-dataset/)  and implemented using Mindspore.
